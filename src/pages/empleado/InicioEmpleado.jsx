      ...
      <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-2">
        ...
        <div className="px-6 py-4 border-t border-slate-100 flex gap-3 items-center">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-[#004bb4] hover:bg-[#003785] disabled:opacity-40 text-white text-sm font-semibold rounded-xl transition-all"
          >
            <Send size={15} />
